...
*                                                *
**************************************************
RAMS    EQU   $2000          ; Start of RAM
EM      EQU   $4000          ; End of RAM + 1
...
ORIG    LDA   #$03           ; Configure the ACIA
        ...
        STA   ACIAC
        LDY   #ENTRY
        LDS   #$3FA0         ; Initial stack pointers
        LDU   #$3F20
...
COLD    FDB   DOCOL
        ...
        FDB   AT
        FDB   SUBB
        FDB   HEX ;djrm: bugfix, cold start has base set to 0 causing undefined bahaviour, (hangup or garbage) when printing number below
        FDB   UDOT
        FDB   PDOTQ
        FCB   5
        FCC   'bytes'
